...
const (
	...
	UserV1_CheckUsersExist_FullMethodName = "/user_v1.UserV1/CheckUsersExist"
)
...
type UserV1Client interface {
	...
	CheckUsersExist(ctx context.Context, in *CheckUsersExistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userV1Client) CheckUsersExist(ctx context.Context, in *CheckUsersExistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserV1_CheckUsersExist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserV1Server interface {
	...
	CheckUsersExist(context.Context, *CheckUsersExistRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserV1Server) CheckUsersExist(context.Context, *CheckUsersExistRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckUsersExist not implemented")
}
...
func _UserV1_CheckUsersExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckUsersExistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserV1Server).CheckUsersExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserV1_CheckUsersExist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).CheckUsersExist(ctx, req.(*CheckUsersExistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckUsersExist",
			Handler:    _UserV1_CheckUsersExist_Handler,
		},
	},
