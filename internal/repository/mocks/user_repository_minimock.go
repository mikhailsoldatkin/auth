...
type UserRepositoryMock struct {
	...
	funcLogAction          func(ctx context.Context, userID int64, details string) (err error)
	inspectFuncLogAction   func(ctx context.Context, userID int64, details string)
	afterLogActionCounter  uint64
	beforeLogActionCounter uint64
	LogActionMock          mUserRepositoryMockLogAction
...
func NewUserRepositoryMock(t minimock.Tester) *UserRepositoryMock {
	...
	m.LogActionMock = mUserRepositoryMockLogAction{mock: m}
	m.LogActionMock.callArgs = []*UserRepositoryMockLogActionParams{}
...
type mUserRepositoryMockLogAction struct {
	optional           bool
	mock               *UserRepositoryMock
	defaultExpectation *UserRepositoryMockLogActionExpectation
	expectations       []*UserRepositoryMockLogActionExpectation

	callArgs []*UserRepositoryMockLogActionParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// UserRepositoryMockLogActionExpectation specifies expectation struct of the UserRepository.LogAction
type UserRepositoryMockLogActionExpectation struct {
	mock      *UserRepositoryMock
	params    *UserRepositoryMockLogActionParams
	paramPtrs *UserRepositoryMockLogActionParamPtrs
	results   *UserRepositoryMockLogActionResults
	Counter   uint64
}

// UserRepositoryMockLogActionParams contains parameters of the UserRepository.LogAction
type UserRepositoryMockLogActionParams struct {
	ctx     context.Context
	userID  int64
	details string
}

// UserRepositoryMockLogActionParamPtrs contains pointers to parameters of the UserRepository.LogAction
type UserRepositoryMockLogActionParamPtrs struct {
	ctx     *context.Context
	userID  *int64
	details *string
}

// UserRepositoryMockLogActionResults contains results of the UserRepository.LogAction
type UserRepositoryMockLogActionResults struct {
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmLogAction *mUserRepositoryMockLogAction) Optional() *mUserRepositoryMockLogAction {
	mmLogAction.optional = true
	return mmLogAction
}

// Expect sets up expected params for UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) Expect(ctx context.Context, userID int64, details string) *mUserRepositoryMockLogAction {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}

	if mmLogAction.defaultExpectation == nil {
		mmLogAction.defaultExpectation = &UserRepositoryMockLogActionExpectation{}
	}

	if mmLogAction.defaultExpectation.paramPtrs != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by ExpectParams functions")
	}

	mmLogAction.defaultExpectation.params = &UserRepositoryMockLogActionParams{ctx, userID, details}
...
// ExpectCtxParam1 sets up expected param ctx for UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) ExpectCtxParam1(ctx context.Context) *mUserRepositoryMockLogAction {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}
	...
	if mmLogAction.defaultExpectation.params != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Expect")
	}

	if mmLogAction.defaultExpectation.paramPtrs == nil {
		mmLogAction.defaultExpectation.paramPtrs = &UserRepositoryMockLogActionParamPtrs{}
	}
...
// ExpectUserIDParam2 sets up expected param userID for UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) ExpectUserIDParam2(userID int64) *mUserRepositoryMockLogAction {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}
	...
	mmLogAction.defaultExpectation.paramPtrs.userID = &userID

	return mmLogAction
}

// ExpectDetailsParam3 sets up expected param details for UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) ExpectDetailsParam3(details string) *mUserRepositoryMockLogAction {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}
	...
	mmLogAction.defaultExpectation.paramPtrs.details = &details

	return mmLogAction
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) Inspect(f func(ctx context.Context, userID int64, details string)) *mUserRepositoryMockLogAction {
	if mmLogAction.mock.inspectFuncLogAction != nil {
		mmLogAction.mock.t.Fatalf("Inspect function is already set for UserRepositoryMock.LogAction")
	}
...
// Return sets up results that will be returned by UserRepository.LogAction
func (mmLogAction *mUserRepositoryMockLogAction) Return(err error) *UserRepositoryMock {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}

	if mmLogAction.defaultExpectation == nil {
		mmLogAction.defaultExpectation = &UserRepositoryMockLogActionExpectation{mock: mmLogAction.mock}
	}
	mmLogAction.defaultExpectation.results = &UserRepositoryMockLogActionResults{err}
	return mmLogAction.mock
}

// Set uses given function f to mock the UserRepository.LogAction method
func (mmLogAction *mUserRepositoryMockLogAction) Set(f func(ctx context.Context, userID int64, details string) (err error)) *UserRepositoryMock {
	if mmLogAction.defaultExpectation != nil {
		mmLogAction.mock.t.Fatalf("Default expectation is already set for the UserRepository.LogAction method")
	}

	if len(mmLogAction.expectations) > 0 {
		mmLogAction.mock.t.Fatalf("Some expectations are already set for the UserRepository.LogAction method")
	}
...
// When sets expectation for the UserRepository.LogAction which will trigger the result defined by the following
// Then helper
func (mmLogAction *mUserRepositoryMockLogAction) When(ctx context.Context, userID int64, details string) *UserRepositoryMockLogActionExpectation {
	if mmLogAction.mock.funcLogAction != nil {
		mmLogAction.mock.t.Fatalf("UserRepositoryMock.LogAction mock is already set by Set")
	}

	expectation := &UserRepositoryMockLogActionExpectation{
		mock:   mmLogAction.mock,
		params: &UserRepositoryMockLogActionParams{ctx, userID, details},
	}
	mmLogAction.expectations = append(mmLogAction.expectations, expectation)
	return expectation
}

// Then sets up UserRepository.LogAction return parameters for the expectation previously defined by the When method
func (e *UserRepositoryMockLogActionExpectation) Then(err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockLogActionResults{err}
	return e.mock
}

// Times sets number of times UserRepository.LogAction should be invoked
func (mmLogAction *mUserRepositoryMockLogAction) Times(n uint64) *mUserRepositoryMockLogAction {
	if n == 0 {
		mmLogAction.mock.t.Fatalf("Times of UserRepositoryMock.LogAction mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmLogAction.expectedInvocations, n)
	return mmLogAction
}

func (mmLogAction *mUserRepositoryMockLogAction) invocationsDone() bool {
...
// LogAction implements repository.UserRepository
func (mmLogAction *UserRepositoryMock) LogAction(ctx context.Context, userID int64, details string) (err error) {
	...
	if mmLogAction.inspectFuncLogAction != nil {
		mmLogAction.inspectFuncLogAction(ctx, userID, details)
	}

	mm_params := UserRepositoryMockLogActionParams{ctx, userID, details}
	...
	if mmLogAction.LogActionMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockLogActionParams{ctx, userID, details}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmLogAction.t.Errorf("UserRepositoryMock.LogAction got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmLogAction.t.Errorf("UserRepositoryMock.LogAction got unexpected parameter userID, want: %#v, got: %#v%s\n", *mm_want_ptrs.userID, mm_got.userID, minimock.Diff(*mm_want_ptrs.userID, mm_got.userID))
			}

			if mm_want_ptrs.details != nil && !minimock.Equal(*mm_want_ptrs.details, mm_got.details) {
				mmLogAction.t.Errorf("UserRepositoryMock.LogAction got unexpected parameter details, want: %#v, got: %#v%s\n", *mm_want_ptrs.details, mm_got.details, minimock.Diff(*mm_want_ptrs.details, mm_got.details))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmLogAction.t.Errorf("UserRepositoryMock.LogAction got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmLogAction.LogActionMock.defaultExpectation.results
		if mm_results == nil {
			mmLogAction.t.Fatal("No results are set for the UserRepositoryMock.LogAction")
		}
		return (*mm_results).err
	}
	if mmLogAction.funcLogAction != nil {
		return mmLogAction.funcLogAction(ctx, userID, details)
	}
	mmLogAction.t.Fatalf("Unexpected call to UserRepositoryMock.LogAction. %v %v %v", ctx, userID, details)
	return
}

// LogActionAfterCounter returns a count of finished UserRepositoryMock.LogAction invocations
func (mmLogAction *UserRepositoryMock) LogActionAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmLogAction.afterLogActionCounter)
}

// LogActionBeforeCounter returns a count of UserRepositoryMock.LogAction invocations
func (mmLogAction *UserRepositoryMock) LogActionBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmLogAction.beforeLogActionCounter)
}

// Calls returns a list of arguments used in each call to UserRepositoryMock.LogAction.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmLogAction *mUserRepositoryMockLogAction) Calls() []*UserRepositoryMockLogActionParams {
	mmLogAction.mutex.RLock()

	argCopy := make([]*UserRepositoryMockLogActionParams, len(mmLogAction.callArgs))
...
// the number of defined expectations
func (m *UserRepositoryMock) MinimockLogActionDone() bool {
...
func (m *UserRepositoryMock) MinimockLogActionInspect() {
	for _, e := range m.LogActionMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.LogAction with params: %#v", *e.params)
		}
	}
	...
	if m.LogActionMock.defaultExpectation != nil && afterLogActionCounter < 1 {
		if m.LogActionMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to UserRepositoryMock.LogAction")
		} else {
			m.t.Errorf("Expected call to UserRepositoryMock.LogAction with params: %#v", *m.LogActionMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.LogActionMock.invocationsDone() && afterLogActionCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.LogAction but found %d calls",
			mm_atomic.LoadUint64(&m.LogActionMock.expectedInvocations), afterLogActionCounter)
	}
}
